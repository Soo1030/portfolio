...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Soo Teng Xiang — Game Tech Portfolio" },
      { name: "description", content: "Portfolio of Soo Teng Xiang, Bachelor of Game Technology student at UTeM." },
      { name: "author", content: "Soo Teng Xiang" },
